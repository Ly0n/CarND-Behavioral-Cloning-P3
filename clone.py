    ...
    while 1:
        ...
        for offset in range(0,num_samples,batch_size):
                 ...
                 for batch_sample in batch_samples:
                    ...
                    images.append(crop_image(imageio.imread(current_path + filename1)))
                    images.append(crop_image(imageio.imread(current_path + filename2)))
                    images.append(crop_image(imageio.imread(current_path + filename3)))
